...
if statements 
hvis pulsen er for høj eller for lav så send en advarsel
hvis den er tilpads så vær inaktiv
...
hvis de er faldet så skriv det ind i databasen med deres koodrinater
...
hvis der er 2 eller flere problemer så kommer de også frem på samme tid
